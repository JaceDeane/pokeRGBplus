...
.main
	...
	bit 7, a
	jr nz, .exit
	call Pokedex_RunJumptable ; equivalent to HandlePokedexListMenu [RB]?
	call DelayFrame
	jr .main
...
INCLUDE "data/pokemon/dex_order_family.asm"
