...
InitializeEventsScript:
	...
	setevent EVENT_OAK_APPEARED_IN_PALLET ; New Events
	; setevent EVENT_GAMBLER_AWAKE
	; setevent EVENT_ROUTE22_RIVAL_WANTS_BATTLE
	; setevent EVENT_TEAM_ROCKET_APPEARED_MT_MOON
	; setevent EVENT_TEAM_ROCKET_APPEARED_CELADON_CITY
	; setevent EVENT_TEAM_ROCKET_APPEARED_LAVENDER_TOWN
	; setevent EVENT_TEAM_ROCKET_APPEARED_SAFFRON
