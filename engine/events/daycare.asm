; PrintDayCareText.TextTable indexes
	...
	const DAYCARETEXT_WHICH_MON
	const DAYCARETEXT_LOOK_AFTER_MON
	const DAYCARETEXT_IN_A_WHILE
	const DAYCARETEXT_MON_HAS_GROWN
	const DAYCARETEXT_OWE_MONEY
	const DAYCARETEXT_GOT_MON_BACK
	const DAYCARETEXT_NEEDS_MORE_TIME
	const DAYCARETEXT_ALL_RIGHT_COME_AGAIN ; Unified
	const DAYCARETEXT_NO_ROOM
	const DAYCARETEXT_ONLY_ONE_MON
	const DAYCARETEXT_MON_WITH_HM
	const DAYCARETEXT_HERES_YOUR_MON
	const DAYCARETEXT_NOT_ENOUGH_MONEY
	; New for Gen II edge cases
	const DAYCARETEXT_CANT_BREED_EGG
	const DAYCARETEXT_REMOVE_MAIL
	const DAYCARETEXT_LAST_HEALTHY_MON
...
.OutOfUsableMons:
	ld a, DAYCARETEXT_LAST_HEALTHY_MON
	scf
	ret
...
DayCare_DepositPokemonText:
	ld a, DAYCARETEXT_LOOK_AFTER_MON ; DAYCARETEXT_DEPOSIT
	call PrintDayCareText
	ld a, [wCurPartySpecies]
	call PlayMonCry
	ld a, DAYCARETEXT_IN_A_WHILE
	call PrintDayCareText
	ret
...
DayCare_AskWithdrawBreedMon:
	...
	ld a, DAYCARETEXT_NEEDS_MORE_TIME
	call PrintDayCareText
	; call YesNoBox
	; jr c, .refused
	; jr .check_money
...
; entries correspond to DAYCARETEXT_* constants
	...
	dw .IntroText               ; 01
	dw .WhichMonText            ; 02
	dw .WillLookAfterMonText    ; 03
	dw .ComeSeeMeInAWhileText   ; 04
	dw .MonHasGrownText         ; 05
	dw .OweMoneyText            ; 06
	dw .GotMonBackText          ; 07
	dw .MonNeedsMoreTimeText    ; 08
	dw .AllRightComeAgainText   ; 09 - Unified
	dw .NoRoomForMonText        ; 10
	dw .OnlyHaveOneMonText      ; 11
	dw .CantAcceptMonWithHMText ; 12 -- Keep this…?
	dw .HeresYourMonText        ; 13
	dw .NotEnoughMoneyText      ; 14
	; New for Gen II edge cases
	dw .CantAcceptEggText       ; 15
	dw .RemoveMailText          ; 16
	dw .LastHealthyMonText      ; 17
...
.AllRightComeAgainText: ; Unified
	text_far _DaycareGentlemanAllRightComeAgainText
	text_end
...
; New for Gen II edge cases
.CantAcceptEggText:
	text_far _DaycareGentlemanCantAcceptEggText
	text_end

.RemoveMailText:
	text_far _DaycareGentlemanRemoveMailText
	text_end

.LastHealthyMonText:
	text_far _DaycareGentlemanLastHealthyMonText
	text_end
