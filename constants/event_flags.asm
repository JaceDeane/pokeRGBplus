...
; Kanto Events - R/B (New)
	const EVENT_HIDDEN_OBJECT ; 'const_skip' can be used to reserve a flag's address
; Pallet Town
...
; Lavender Town events
	...
	const EVENT_IN_PURIFIED_ZONE ;Reserving early (is this needed?)
...
; Route 16 events
	...
	; const EVENT_RESCUED_MR_FUJI_2 ;R/B set, but unchecked
...
; Mt. Moon events
	...
	const EVENT_MT_MOON_B2F_TM_MEGA_PUNCH ; TODO
	;Events
...
; S.S. Anne events
	const EVENT_SS_ANNE_2F_CABINS_MAX_ETHER
	const EVENT_SS_ANNE_2F_CABINS_RARE_CANDY
	const EVENT_SS_ANNE_B1F_CABINS_ETHER
	const EVENT_SS_ANNE_B1F_CABINS_MAX_POTION
	const EVENT_BEAT_RIVAL_SS_ANNE_2F
...
; Unused: next 167 events
	...
	const_next 1000
; Trainer flags
; Swimmer F -- All updated
	const EVENT_BEAT_SWIMMERF_TIFFANY
	const EVENT_BEAT_SWIMMERF_NORA
	const EVENT_BEAT_SWIMMERF_MELISSA
	const EVENT_BEAT_SWIMMERF_ANYA
	const EVENT_BEAT_SWIMMERF_ALICE
	const EVENT_BEAT_SWIMMERF_CONNIE
	const EVENT_BEAT_SWIMMERF_SHIRLEY
; Bird Keeper -- All updated
	const EVENT_BEAT_BIRD_KEEPER_SEBASTIAN
	const EVENT_BEAT_BIRD_KEEPER_PERRY
	const EVENT_BEAT_BIRD_KEEPER_ROBERT
	const EVENT_BEAT_BIRD_KEEPER_DONALD
	const EVENT_BEAT_BIRD_KEEPER_BENNY
	const EVENT_BEAT_BIRD_KEEPER_EDWIN
	const EVENT_BEAT_BIRD_KEEPER_CHESTER
	const EVENT_BEAT_BIRD_KEEPER_WILTON
	const EVENT_BEAT_BIRD_KEEPER_RAMIRO
	const EVENT_BEAT_BIRD_KEEPER_JACOB
	const EVENT_BEAT_BIRD_KEEPER_ROGER
	const EVENT_BEAT_BIRD_KEEPER_REED
	const EVENT_BEAT_BIRD_KEEPER_KEITH
	const EVENT_BEAT_BIRD_KEEPER_CARTER
	const EVENT_BEAT_BIRD_KEEPER_MITCH
	const EVENT_BEAT_BIRD_KEEPER_BECK
	const EVENT_BEAT_BIRD_KEEPER_MARLON
; Boarder
...
; Burglar -- All updated
	const EVENT_BEAT_BURGLAR_BURGLAR_UNUSED1
	const EVENT_BEAT_BURGLAR_BURGLAR_UNUSED2
	const EVENT_BEAT_BURGLAR_BURGLAR_UNUSED3
	const EVENT_BEAT_BURGLAR_QUINN
	const EVENT_BEAT_BURGLAR_RAMON
	const EVENT_BEAT_BURGLAR_DUSTY
	const EVENT_BEAT_BURGLAR_ARNIE
	const EVENT_BEAT_BURGLAR_SIMON
	const EVENT_BEAT_BURGLAR_LEWIS
; Biker -- All updated
	const EVENT_BEAT_BIKER_JARED
	const EVENT_BEAT_BIKER_MALIK
	const EVENT_BEAT_BIKER_ERNEST
	const EVENT_BEAT_BIKER_ALEX
	const EVENT_BEAT_BIKER_LAO
	const EVENT_BEAT_BIKER_BIKER_UNUSED
	const EVENT_BEAT_BIKER_HIDEO
	const EVENT_BEAT_BIKER_RUBEN
	const EVENT_BEAT_BIKER_BILLY
	const EVENT_BEAT_BIKER_NIKOLAS
	const EVENT_BEAT_BIKER_JAXON
	const EVENT_BEAT_BIKER_WILLIAM
	const EVENT_BEAT_BIKER_LUKAS
	const EVENT_BEAT_BIKER_ISAAC
	const EVENT_BEAT_BIKER_GERALD
; Psychic -- All updated
	const EVENT_BEAT_PSYCHIC_JOHAN
	const EVENT_BEAT_PSYCHIC_TYRON
	const EVENT_BEAT_PSYCHIC_CAMERON
	const EVENT_BEAT_PSYCHIC_PRESTON
; Firebreather
...
; Fisher -- All updated
	...
	const EVENT_BEAT_FISHER_BARNY
	const EVENT_BEAT_FISHER_NED
	const EVENT_BEAT_FISHER_CHIP
	const EVENT_BEAT_FISHER_HANK
	const EVENT_BEAT_FISHER_ELLIOT
	const EVENT_BEAT_FISHER_RONALD
	const EVENT_BEAT_FISHER_CLAUDE
	const EVENT_BEAT_FISHER_WADE
	const EVENT_BEAT_FISHER_NOLAN
	const EVENT_BEAT_FISHER_ANDREW
; Twins
...
; Juggler -- All updated
	const EVENT_BEAT_JUGGLER_DALTON
	const EVENT_BEAT_JUGGLER_NELSON
	const EVENT_BEAT_JUGGLER_KIRK
	const EVENT_BEAT_JUGGLER_SHAWN
	const EVENT_BEAT_JUGGLER_GREGORY
	const EVENT_BEAT_JUGGLER_EDWARD
	const EVENT_BEAT_JUGGLER_KAYDEN
	const EVENT_BEAT_JUGGLER_NATE
; Gentleman -- All updated
	const EVENT_BEAT_GENTLEMAN_THOMAS
	const EVENT_BEAT_GENTLEMAN_ARTHUR
	const EVENT_BEAT_GENTLEMAN_BROOKS ; Same in R/B
	const EVENT_BEAT_GENTLEMAN_TUCKER ; Same in R/B
	const EVENT_BEAT_GENTLEMAN_NORTON
	const EVENT_BEAT_GENTLEMAN_WALTER ; LAMAR in FR/LG
; Scientist -- All updated
	const EVENT_BEAT_SCIENTIST_TED
	const EVENT_BEAT_SCIENTIST_CONNOR
	const EVENT_BEAT_SCIENTIST_JERRY
	const EVENT_BEAT_SCIENTIST_JOSE
	const EVENT_BEAT_SCIENTIST_RODNEY
	const EVENT_BEAT_SCIENTIST_BEAU
	const EVENT_BEAT_SCIENTIST_TAYLOR
	const EVENT_BEAT_SCIENTIST_JOSHUA
	const EVENT_BEAT_SCIENTIST_PARKER
	const EVENT_BEAT_SCIENTIST_ED
	const EVENT_BEAT_SCIENTIST_TRAVIS
	const EVENT_BEAT_SCIENTIST_BRAYDON
	const EVENT_BEAT_SCIENTIST_IVAN
; Blackbelt -- All updated
	const EVENT_BEAT_BLACKBELT_KOICHI
	...
	const EVENT_BEAT_BLACKBELT_ATSUSHI
...
; Beauty -- All updated
	...
	const EVENT_BEAT_BEAUTY_TAMIA
	const EVENT_BEAT_BEAUTY_LORI
	const EVENT_BEAT_BEAUTY_LOLA
	const EVENT_BEAT_BEAUTY_SHEILA
	const EVENT_BEAT_BEAUTY_TIFFANY ; Becomes SWIMMERF in FR/LG
	const EVENT_BEAT_BEAUTY_NORA ; Becomes SWIMMERF in FR/LG
	const EVENT_BEAT_BEAUTY_MELISSA ; Becomes SWIMMERF in FR/LG
	const EVENT_BEAT_BEAUTY_GRACE
	const EVENT_BEAT_BEAUTY_OLIVIA
	const EVENT_BEAT_BEAUTY_LAUREN
	const EVENT_BEAT_BEAUTY_ANYA ; Becomes SWIMMERF in FR/LG
	const EVENT_BEAT_BEAUTY_ALICE ; Becomes SWIMMERF in FR/LG
	const EVENT_BEAT_BEAUTY_CONNIE ; Becomes SWIMMERF in FR/LG
	const EVENT_BEAT_BEAUTY_SHIRLEY ; Becomes SWIMMERF in FR/LG
; Johto Gym Leaders
...
; Pokemaniac -- All updated
	const EVENT_BEAT_POKEMANIAC_MARK
	const EVENT_BEAT_POKEMANIAC_HERMAN
	const EVENT_BEAT_POKEMANIAC_COOPER
	const EVENT_BEAT_POKEMANIAC_STEVE
	const EVENT_BEAT_POKEMANIAC_WINSTON
	const EVENT_BEAT_POKEMANIAC_DAWSON
...
; CooltrainerM -- All updated
	const EVENT_BEAT_COOLTRAINERM_SAMUEL
	const EVENT_BEAT_COOLTRAINERM_GEORGE
	const EVENT_BEAT_COOLTRAINERM_COLBY
	const EVENT_BEAT_COOLTRAINERM_PAUL
	const EVENT_BEAT_COOLTRAINERM_ROLANDO
	const EVENT_BEAT_COOLTRAINERM_GILBERT
	const EVENT_BEAT_COOLTRAINERM_OWEN
	const EVENT_BEAT_COOLTRAINERM_BERKE
	const EVENT_BEAT_COOLTRAINERM_YUJI
	const EVENT_BEAT_COOLTRAINERM_WARREN
; CooltrainerF -- All updated
	const EVENT_BEAT_COOLTRAINERF_MARY
	const EVENT_BEAT_COOLTRAINERF_CAROLINE
	const EVENT_BEAT_COOLTRAINERF_ALEXA
	const EVENT_BEAT_COOLTRAINERF_SHANNON
	const EVENT_BEAT_COOLTRAINERF_NAOMI
	const EVENT_BEAT_COOLTRAINERF_BROOKE
	const EVENT_BEAT_COOLTRAINERF_AUSTINA
	const EVENT_BEAT_COOLTRAINERF_JULIE
; ExecutiveF
...
; Sailor -- All updated
	const EVENT_BEAT_SAILOR_EDMOND
	const EVENT_BEAT_SAILOR_TREVOR
	const EVENT_BEAT_SAILOR_LEONARD
	const EVENT_BEAT_SAILOR_DUNCAN
	const EVENT_BEAT_SAILOR_HUEY
	const EVENT_BEAT_SAILOR_DYLAN
	const EVENT_BEAT_SAILOR_PHILLIP
	const EVENT_BEAT_SAILOR_DWAYNE
...
; Channeler (R/B)
	const EVENT_BEAT_CHANNELER_PATRICIA
	const EVENT_BEAT_CHANNELER_CARLY
	const EVENT_BEAT_CHANNELER_HOPE
	const EVENT_BEAT_CHANNELER_PAULA
	const EVENT_BEAT_CHANNELER_LAUREL
	const EVENT_BEAT_CHANNELER_JODY
	const EVENT_BEAT_CHANNELER_TAMMY
	const EVENT_BEAT_CHANNELER_RUTH
	const EVENT_BEAT_CHANNELER_KARINA
	const EVENT_BEAT_CHANNELER_JANAE
	const EVENT_BEAT_CHANNELER_ANGELICA
	const EVENT_BEAT_CHANNELER_EMILIA
	const EVENT_BEAT_CHANNELER_JENNIFER
	const EVENT_BEAT_CHANNELER_AMANDA
	const EVENT_BEAT_CHANNELER_STACY
	const EVENT_BEAT_CHANNELER_TASHA
; Cue Ball (R/B)
	const EVENT_BEAT_CUE_BALL_KOJI
	const EVENT_BEAT_CUE_BALL_LUKE
	const EVENT_BEAT_CUE_BALL_CAMRON
	const EVENT_BEAT_CUE_BALL_RAUL
	const EVENT_BEAT_CUE_BALL_ISAIAH
	const EVENT_BEAT_CUE_BALL_ZEEK
	const EVENT_BEAT_CUE_BALL_JAMAL
	const EVENT_BEAT_CUE_BALL_COREY
	const EVENT_BEAT_CUE_BALL_CHASE
; Engineer (R/B)
	const EVENT_BEAT_ENGINEER_BAILY ; Unused R/B
	const EVENT_BEAT_ENGINEER_BRAXTON
	const EVENT_BEAT_ENGINEER_BERNIE
; Gambler (R/B)
	const EVENT_BEAT_GAMBLER_HUGO
	const EVENT_BEAT_GAMBLER_JASPER
	const EVENT_BEAT_GAMBLER_DIRK
	const EVENT_BEAT_GAMBLER_DARIAN
	const EVENT_BEAT_GAMBLER_STAN
	const EVENT_BEAT_GAMBLER_GAMBLER_UNUSED; Unused R/B
	const EVENT_BEAT_GAMBLER_RICH
; Rocker (R/B)
	const EVENT_BEAT_ROCKER_RANDALL
	const EVENT_BEAT_ROCKER_LUCA
; Tamer (R/B)
	const EVENT_BEAT_TAMER_PHIL
	const EVENT_BEAT_TAMER_EDGAR
	const EVENT_BEAT_TAMER_JASON
	const EVENT_BEAT_TAMER_COLE
	const EVENT_BEAT_TAMER_VINCENT
	const EVENT_BEAT_TAMER_JOHN ; Unused R/B
...
; Unused: next 125 events -- updated
...
; Johto people
	...
	const_skip ; const EVENT_MET_BILL
...
; Raw R/B item HIDE_SHOW data for non-TM "actual item" itemballs
; TODO -- sort and apply
	; ROUTE12_IRON
	...
	; ;Viridian Forest
	; ;Mt Moon - already added, in regular EVENT flags area :|
	; ;SS Anne - "
