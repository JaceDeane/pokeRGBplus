...
; wVisitedSpawns
	...
	const ENGINE_FLYPOINT_NEW_BARK ; Unused RGB+
	const ENGINE_FLYPOINT_CHERRYGROVE ; Unused RGB+
	const ENGINE_FLYPOINT_VIOLET ; Unused RGB+
	const ENGINE_FLYPOINT_AZALEA ; Unused RGB+
	const ENGINE_FLYPOINT_CIANWOOD ; Unused RGB+
	const ENGINE_FLYPOINT_GOLDENROD ; Unused RGB+
	const ENGINE_FLYPOINT_OLIVINE ; Unused RGB+
	const ENGINE_FLYPOINT_ECRUTEAK ; Unused RGB+
	const ENGINE_FLYPOINT_MAHOGANY ; Unused RGB+
	const ENGINE_FLYPOINT_LAKE_OF_RAGE ; Unused RGB+
	const ENGINE_FLYPOINT_BLACKTHORN ; Unused RGB+
