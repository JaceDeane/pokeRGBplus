...
ChrisSpriteGFX::               INCBIN "gfx/sprites/red.2bpp"
ChrisBikeSpriteGFX::           INCBIN "gfx/sprites/red_bike.2bpp"
...
OldLinkReceptionistSpriteGFX:: ;INCBIN "gfx/sprites/old_link_receptionist.2bpp" ; Unused, unused in RGB+
...
GrampsAsleepSpriteGFX::        INCBIN "gfx/sprites/gramps_asleep.2bpp"
