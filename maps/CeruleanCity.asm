...
CeruleanCity_MapEvents:
	...
	warp_event 13, 15, CERULEAN_TRADE_SPEECH_HOUSE, 1 ; TRADE_HOUSE
	...
	def_object_events
	object_event 20,  2, SPRITE_BLUE, SPRITEMOVEDATA_STANDING_DOWN, 0, 0, -1, -1, 0, OBJECTTYPE_SCRIPT, 0, ObjectEvent, -1
	...
	object_event 27, 12, SPRITE_OFFICER, SPRITEMOVEDATA_STANDING_DOWN, 0, 0, -1, -1, PAL_NPC_RED, OBJECTTYPE_SCRIPT, 0, CeruleanCityGuardScript, -1
