InitialEvents:
	...
	; New Events
	dw EVENT_HIDDEN_OBJECT ; DO NOT SET/CLEAR
	dw EVENT_OAK_APPEARED_IN_PALLET
	dw EVENT_GAMBLER_AWAKE
	dw EVENT_ROUTE_22_RIVAL_APPEAR
	dw EVENT_CERULEAN_CITY_RIVAL_APPEAR
	dw EVENT_USED_CELL_SEPARATOR_ON_BILL
	dw EVENT_LEFT_BILLS_HOUSE_AFTER_HELPING
	; dw EVENT_TEAM_ROCKET_APPEAR_CELADON_CITY
	; dw EVENT_TEAM_ROCKET_APPEAR_LAVENDER_TOWN
	; dw EVENT_TEAM_ROCKET_APPEAR_SAFFRON
	; dw EVENT_CERULEAN_RIVAL_WANTS_BATTLE
	
	; Initially Hidden People
	dw EVENT_MR_FUJI
...
ENDM
	...
	initvarsprite SPRITE_JIGGLYPUFF_PEWTER, SPRITE_JIGGLYPUFF
	db -1 ; end