...
KogaGroup:
	; KOGA (1) -- TODO: Yellow team(?)
	db "KOGA@", TRAINERTYPE_MOVES
	db 40, KOFFING,    DOUBLE_TEAM, SPIDER_WEB, BATON_PASS, GIGA_DRAIN ; EDIT MOVES
	db 42, MUK,        MINIMIZE, ACID_ARMOR, SLUDGE_BOMB, TOXIC ; EDIT MOVES
	db 43, KOFFING,    PROTECT, SWIFT, EXPLOSION, SPIKES ; EDIT MOVES
	db 42, WEEZING,    MINIMIZE, ACID_ARMOR, SLUDGE_BOMB, TOXIC ; EDIT MOVES
...
ScientistGroup:
	; SCIENTIST (1) ; Unused R/B -- used in FR/LG
	db "TED@", TRAINERTYPE_NORMAL
	db 34, KOFFING
	db 34, VOLTORB
	; db 29, ELECTRODE ; FR/LG
	; db 29, WEEZING ; FR/LG
	db -1 ; end
...
ErikaGroup:
	...
	db 29, VICTREEBEL, SUNNY_DAY, SYNTHESIS, ACID, RAZOR_LEAF ; EDIT MOVES
	db 24, TANGELA,    VINE_WHIP, BIND, GIGA_DRAIN, SLEEP_POWDER ; EDIT MOVES
	db 29, VILEPLUME,   MEGA_DRAIN, LEECH_SEED, COTTON_SPORE, GIGA_DRAIN ; EDIT MOVES
	db -1 ; end
...
BirdKeeperGroup: ; Updated to R/B, using FR/LG names
	; BIRD_KEEPER (1)
	...
	; BIRD_KEEPER (12) ; Unused R/B
	db "REED@", TRAINERTYPE_NORMAL
	db 39, PIDGEOTTO
	db 39, PIDGEOTTO
	db 39, PIDGEY
	db 39, PIDGEOTTO
...
CooltrainerMGroup:
	...
	; COOLTRAINERM (4) ; Unused R/B -- used in FR/LG
	...
	; COOLTRAINERM (6) ; Unused R/B -- used in FR/LG
	...
	; COOLTRAINERM (7) ; Unused R/B -- used in FR/LG
	db "OWEN@", TRAINERTYPE_NORMAL
	db 49, NIDOKING
	db -1 ; end

	; COOLTRAINERM (8) ; Unused R/B -- used in FR/LG
...
CooltrainerFGroup:
	...
	; COOLTRAINERF (4) ; Unused R/B -- used in FR/LG
	...
	; COOLTRAINERF (6) ; Unused R/B -- used in FR/LG
	db "BROOKE@", TRAINERTYPE_NORMAL
	db 45, IVYSAUR
	db 45, VENUSAUR
	db -1 ; end

	; COOLTRAINERF (7) ; Unused R/B -- used in FR/LG
	db "AUSTINA@", TRAINERTYPE_NORMAL
	db 45, NIDORINA
	db 45, NIDOQUEEN
	db -1 ; end

	; COOLTRAINERF (8) ; Unused R/B -- used in FR/LG
...
HikerGroup: ; Updated to R/B, using FR/LG names
	...
	; HIKER (12) ERIC and JEREMY same "Trainer" party in R/B
...
BlackbeltGroup: ; Updated to R/B, using FR/LG names
	; BLACKBELT_T (1)
...
PicnickerGroup: ; Updated to R/B, using FR/LG names
	...
	; PICNICKER (4) ; Unused in R/B -- replaces LASS_9 in FR/LG as "KELSEY"
	db "UNUSED@", TRAINERTYPE_NORMAL
	db 22, BULBASAUR
