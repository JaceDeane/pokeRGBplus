...
MonMenuIcons:
	...
	db ICON_BIRD        ; DODUO
	db ICON_BIRD        ; DODRIO
	db ICON_WATERMON    ; SEEL			-- ICON_LAPRAS in Gen II
	db ICON_WATERMON    ; DEWGONG		-- ICON_LAPRAS in Gen II
	db ICON_BLOB        ; GRIMER
	db ICON_BLOB        ; MUK
	...
	db ICON_WATERMON    ; KRABBY		-- ICON_SHELL in Gen II
	db ICON_WATERMON    ; KINGLER		-- ICON_SHELL in Gen II
	...
	db ICON_WATERMON    ; HORSEA		-- ICON_FISH in Gen II
	db ICON_WATERMON    ; SEADRA		-- ICON_FISH in Gen II
	...
	db ICON_MONSTER     ; ELECTABUZZ	-- ICON_HUMANSHAPE in Gen II
	db ICON_MONSTER     ; MAGMAR		-- ICON_HUMANSHAPE in Gen II
	db ICON_BUG         ; PINSIR
	...
	db ICON_HELIX       ; OMANYTE		-- ICON_SHELL in Gen II
	db ICON_HELIX       ; OMASTAR		-- ICON_SHELL in Gen II
	db ICON_HELIX       ; KABUTO		-- ICON_SHELL in Gen II
	db ICON_HELIX       ; KABUTOPS		-- ICON_SHELL in Gen II
	...
	db ICON_WATERMON    ; KINGDRA		-- ICON_FISH in Gen II
