...
MapGroup_Cerulean:
	...
	map CeruleanGymBadgeSpeechHouse, TILESET_LIGHTHOUSE, INDOOR, LANDMARK_CERULEAN_CITY, MUSIC_CERULEAN_CITY, FALSE, PALETTE_DAY, FISHGROUP_SHORE
...
MapGroup_FastShip:
	...
	map SSAnne1F, TILESET_LIGHTHOUSE, INDOOR, LANDMARK_VERMILION_CITY, MUSIC_SS_ANNE, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map SSAnne2F, TILESET_LIGHTHOUSE, INDOOR, LANDMARK_VERMILION_CITY, MUSIC_SS_ANNE, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map SSAnne3F, TILESET_LIGHTHOUSE, INDOOR, LANDMARK_VERMILION_CITY, MUSIC_SS_ANNE, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map SSAnneB1F, TILESET_LIGHTHOUSE, INDOOR, LANDMARK_VERMILION_CITY, MUSIC_SS_ANNE, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map SSAnneBow, TILESET_LIGHTHOUSE, ROUTE, LANDMARK_VERMILION_CITY, MUSIC_SS_ANNE, FALSE, PALETTE_AUTO, FISHGROUP_SHORE
	map SSAnneKitchen, TILESET_LIGHTHOUSE, INDOOR, LANDMARK_VERMILION_CITY, MUSIC_SS_ANNE, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map SSAnneCaptainsCabin, TILESET_LIGHTHOUSE, INDOOR, LANDMARK_VERMILION_CITY, MUSIC_SS_ANNE, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map SSAnne1FCabins, TILESET_LIGHTHOUSE, INDOOR, LANDMARK_VERMILION_CITY, MUSIC_SS_ANNE, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map SSAnne2FCabins, TILESET_LIGHTHOUSE, INDOOR, LANDMARK_VERMILION_CITY, MUSIC_SS_ANNE, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map SSAnneB1FCabins, TILESET_LIGHTHOUSE, INDOOR, LANDMARK_VERMILION_CITY, MUSIC_SS_ANNE, FALSE, PALETTE_DAY, FISHGROUP_SHORE
...
MapGroup_Viridian:
	...
	map Route2NuggetHouse, TILESET_HOUSE_KANTO, INDOOR, LANDMARK_ROUTE_2, MUSIC_VIRIDIAN_CITY, FALSE, PALETTE_DAY, FISHGROUP_SHORE
