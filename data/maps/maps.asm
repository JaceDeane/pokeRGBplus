...
MapGroup_Viridian:
	...
	map ViridianForestSouthGate, TILESET_GATE_KANTO, GATE, LANDMARK_ROUTE_2, MUSIC_ROUTE_2, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map ViridianForestNorthGate, TILESET_GATE_KANTO, GATE, LANDMARK_ROUTE_2, MUSIC_ROUTE_2, FALSE, PALETTE_DAY, FISHGROUP_SHORE
