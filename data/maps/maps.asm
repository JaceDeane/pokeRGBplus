...
MapGroup_Dungeons:
	...
	map ViridianForest, TILESET_FOREST, FOREST, LANDMARK_VIRIDIAN_FOREST, MUSIC_VIRIDIAN_FOREST, FALSE, PALETTE_NITE, FISHGROUP_SHORE ; TODO - Add Viridian Forest Music
