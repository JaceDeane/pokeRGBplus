...
MapGroup_Vermilion:
	...
	map VermilionGym, TILESET_GAME_CORNER, INDOOR, LANDMARK_VERMILION_CITY, MUSIC_GYM_THEME, TRUE, PALETTE_DAY, FISHGROUP_SHORE
...
MapGroup_Saffron:
	...
	map Route5CleanseTagHouse, TILESET_HOUSE_KANTO, INDOOR, LANDMARK_ROUTE_5, MUSIC_VIRIDIAN_CITY, FALSE, PALETTE_DAY, FISHGROUP_SHORE
