...
MapGroup_Dungeons:
	...
	map ViridianForest, TILESET_FOREST, FOREST, LANDMARK_VIRIDIAN_FOREST, MUSIC_ROUTE_2, FALSE, PALETTE_NITE, FISHGROUP_SHORE ; TODO - Add Viridian Forest Music
...
MapGroup_Pewter:
	...
	map PewterGym, TILESET_GYM, INDOOR, LANDMARK_PEWTER_CITY, MUSIC_GYM, TRUE, PALETTE_DAY, FISHGROUP_SHORE
