...
MapGroup_Dungeons:
	...
	map DiglettsCave, TILESET_DARK_CAVERN, CAVE, LANDMARK_DIGLETTS_CAVE, MUSIC_VIRIDIAN_FOREST, TRUE, PALETTE_NITE, FISHGROUP_SHORE
	map MountMoon1F, TILESET_CAVERN, CAVE, LANDMARK_MT_MOON, MUSIC_MT_MOON, TRUE, PALETTE_NITE, FISHGROUP_SHORE
	map MountMoon1FExit, TILESET_CAVERN, CAVE, LANDMARK_MT_MOON, MUSIC_MT_MOON, TRUE, PALETTE_NITE, FISHGROUP_SHORE
	map MountMoonB1F, TILESET_CAVERN, CAVE, LANDMARK_MT_MOON, MUSIC_MT_MOON, TRUE, PALETTE_NITE, FISHGROUP_SHORE
	map MountMoonB2F, TILESET_CAVERN, CAVE, LANDMARK_MT_MOON, MUSIC_MT_MOON, TRUE, PALETTE_NITE, FISHGROUP_SHORE
	map UndergroundPathNorthSouth, TILESET_UNDERGROUND, GATE, LANDMARK_UNDERGROUND_PATH, MUSIC_ROUTE_1, FALSE, PALETTE_NITE, FISHGROUP_SHORE
	map UndergroundPathWestEast, TILESET_UNDERGROUND, GATE, LANDMARK_UNDERGROUND_PATH, MUSIC_ROUTE_1, FALSE, PALETTE_NITE, FISHGROUP_SHORE
	map RockTunnel1F, TILESET_DARK_CAVERN, CAVE, LANDMARK_ROCK_TUNNEL, MUSIC_MT_MOON, TRUE, PALETTE_DARK, FISHGROUP_SHORE
	map RockTunnel1FEntrance, TILESET_DARK_CAVERN, CAVE, LANDMARK_ROCK_TUNNEL, MUSIC_MT_MOON, TRUE, PALETTE_NITE, FISHGROUP_SHORE
	map RockTunnelB1F, TILESET_DARK_CAVERN, CAVE, LANDMARK_ROCK_TUNNEL, MUSIC_MT_MOON, TRUE, PALETTE_DARK, FISHGROUP_SHORE
	map SafariZoneFuchsiaGateBeta, TILESET_GATE, INDOOR, LANDMARK_FUCHSIA_CITY, MUSIC_CERULEAN_CITY, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	...
	map ViridianForest, TILESET_FOREST, FOREST, LANDMARK_VIRIDIAN_FOREST, MUSIC_VIRIDIAN_FOREST, FALSE, PALETTE_NITE, FISHGROUP_SHORE
	map PokemonTower1F, TILESET_CEMETERY, DUNGEON, LANDMARK_POKEMON_TOWER, MUSIC_POKEMON_TOWER, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map PokemonTower2F, TILESET_CEMETERY, DUNGEON, LANDMARK_POKEMON_TOWER, MUSIC_POKEMON_TOWER, FALSE, PALETTE_NITE, FISHGROUP_SHORE
	map PokemonTower3F, TILESET_CEMETERY, DUNGEON, LANDMARK_POKEMON_TOWER, MUSIC_POKEMON_TOWER, FALSE, PALETTE_NITE, FISHGROUP_SHORE
	map PokemonTower4F, TILESET_CEMETERY, DUNGEON, LANDMARK_POKEMON_TOWER, MUSIC_POKEMON_TOWER, FALSE, PALETTE_NITE, FISHGROUP_SHORE
	map PokemonTower5F, TILESET_CEMETERY, DUNGEON, LANDMARK_POKEMON_TOWER, MUSIC_POKEMON_TOWER, FALSE, PALETTE_NITE, FISHGROUP_SHORE
	map PokemonTower6F, TILESET_CEMETERY, DUNGEON, LANDMARK_POKEMON_TOWER, MUSIC_POKEMON_TOWER, FALSE, PALETTE_NITE, FISHGROUP_SHORE
	map PokemonTower7F, TILESET_CEMETERY, DUNGEON, LANDMARK_POKEMON_TOWER, MUSIC_POKEMON_TOWER, FALSE, PALETTE_NITE, FISHGROUP_SHORE
...
MapGroup_Cinnabar:
	...
	map SeafoamGym, TILESET_CAVE, INDOOR, LANDMARK_SEAFOAM_ISLANDS, MUSIC_GYM_THEME, TRUE, PALETTE_DAY, FISHGROUP_SHORE
	...
	map Route21WestBorder, TILESET_KANTO, ROUTE, LANDMARK_ROUTE_21, MUSIC_ROUTE_3, FALSE, PALETTE_AUTO, FISHGROUP_OCEAN
...
MapGroup_Cerulean:
	...
	map CeruleanGymBadgeSpeechHouse, TILESET_SHIP, INDOOR, LANDMARK_CERULEAN_CITY, MUSIC_CERULEAN_CITY, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map CeruleanTrashedHouse, TILESET_HOUSE_KANTO, INDOOR, LANDMARK_CERULEAN_CITY, MUSIC_CERULEAN_CITY, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map CeruleanBikeShop, TILESET_CHAMPIONS_ROOM, INDOOR, LANDMARK_CERULEAN_CITY, MUSIC_CERULEAN_CITY, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map CeruleanTradeHouse, TILESET_HOUSE_KANTO, INDOOR, LANDMARK_CERULEAN_CITY, MUSIC_CERULEAN_CITY, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	...
	map CeruleanGym, TILESET_GYM, INDOOR, LANDMARK_CERULEAN_CITY, MUSIC_GYM_THEME, TRUE, PALETTE_DAY, FISHGROUP_NONE
	map CeruleanMart, TILESET_MART, INDOOR, LANDMARK_CERULEAN_CITY, MUSIC_CERULEAN_CITY, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map RockTunnelPokecenter, TILESET_POKECENTER, INDOOR, LANDMARK_ROUTE_10, MUSIC_POKEMON_CENTER, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map PowerPlant, TILESET_FACILITY, INDOOR, LANDMARK_POWER_PLANT, MUSIC_VIRIDIAN_CITY, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map BillsHouse, TILESET_INTERIOR, INDOOR, LANDMARK_BILLS_HOUSE, MUSIC_CERULEAN_CITY, FALSE, PALETTE_DAY, FISHGROUP_SHORE
...
MapGroup_Vermilion:
	...
	map VermilionOldRodHouse, TILESET_HOUSE_KANTO, INDOOR, LANDMARK_VERMILION_CITY, MUSIC_VERMILION_CITY, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	...
	map PokemonFanClub, TILESET_INTERIOR, INDOOR, LANDMARK_VERMILION_CITY, MUSIC_VERMILION_CITY, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map VermilionTradeHouse, TILESET_HOUSE_KANTO, INDOOR, LANDMARK_VERMILION_CITY, MUSIC_VERMILION_CITY, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map VermilionMart, TILESET_MART, INDOOR, LANDMARK_VERMILION_CITY, MUSIC_VERMILION_CITY, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map VermilionPidgeyHouse, TILESET_HOUSE_KANTO, INDOOR, LANDMARK_VERMILION_CITY, MUSIC_VERMILION_CITY, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map VermilionGym, TILESET_GYM, INDOOR, LANDMARK_VERMILION_CITY, MUSIC_GYM_THEME, TRUE, PALETTE_DAY, FISHGROUP_SHORE
	map Route6SaffronGate, TILESET_GATE_KANTO, GATE, LANDMARK_ROUTE_6, MUSIC_VIRIDIAN_CITY, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map Route6UndergroundPathEntrance, TILESET_GATE_KANTO, GATE, LANDMARK_ROUTE_6, MUSIC_ROUTE_3, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map Route11Gate1F, TILESET_GATE_KANTO, GATE, LANDMARK_ROUTE_11, MUSIC_ROUTE_3, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map Route11Gate2F, TILESET_GATE_KANTO, GATE, LANDMARK_ROUTE_11, MUSIC_ROUTE_3, FALSE, PALETTE_DAY, FISHGROUP_SHORE
...
MapGroup_Pallet:
	...
	map RedsHouse1F, TILESET_REDS_HOUSE, INDOOR, LANDMARK_PALLET_TOWN, MUSIC_PALLET_TOWN, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map RedsHouse2F, TILESET_REDS_HOUSE, INDOOR, LANDMARK_PALLET_TOWN, MUSIC_PALLET_TOWN, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map BluesHouse, TILESET_HOUSE_KANTO, INDOOR, LANDMARK_PALLET_TOWN, MUSIC_PALLET_TOWN, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map OaksLab, TILESET_GYM, INDOOR, LANDMARK_PALLET_TOWN, MUSIC_POKEMON_TALK, FALSE, PALETTE_DAY, FISHGROUP_SHORE
...
MapGroup_Pewter:
	...
	map PewterNidoranSpeechHouse, TILESET_HOUSE_KANTO, INDOOR, LANDMARK_PEWTER_CITY, MUSIC_VIRIDIAN_CITY, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map PewterGym, TILESET_GYM, INDOOR, LANDMARK_PEWTER_CITY, MUSIC_GYM_THEME, TRUE, PALETTE_DAY, FISHGROUP_SHORE
	...
	map PewterSnoozeSpeechHouse, TILESET_HOUSE_KANTO, INDOOR, LANDMARK_PEWTER_CITY, MUSIC_VIRIDIAN_CITY, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map PewterMuseumOfScience1F, TILESET_GATE_KANTO, INDOOR, LANDMARK_PEWTER_CITY, MUSIC_VIRIDIAN_CITY, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map PewterMuseumOfScience2F, TILESET_GATE_KANTO, INDOOR, LANDMARK_PEWTER_CITY, MUSIC_VIRIDIAN_CITY, FALSE, PALETTE_DAY, FISHGROUP_SHORE
...
MapGroup_FastShip:
	...
	map VermilionDock, TILESET_SHIP_PORT, ROUTE, LANDMARK_VERMILION_CITY, MUSIC_VERMILION_CITY, FALSE, PALETTE_AUTO, FISHGROUP_OCEAN
	...
	map SSAnne1F, TILESET_SHIP, INDOOR, LANDMARK_VERMILION_CITY, MUSIC_SS_ANNE, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map SSAnne2F, TILESET_SHIP, INDOOR, LANDMARK_VERMILION_CITY, MUSIC_SS_ANNE, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map SSAnne3F, TILESET_SHIP, INDOOR, LANDMARK_VERMILION_CITY, MUSIC_SS_ANNE, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map SSAnneB1F, TILESET_SHIP, INDOOR, LANDMARK_VERMILION_CITY, MUSIC_SS_ANNE, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map SSAnneBow, TILESET_SHIP_DECK, ROUTE, LANDMARK_VERMILION_CITY, MUSIC_SS_ANNE, FALSE, PALETTE_AUTO, FISHGROUP_SHORE
	map SSAnneKitchen, TILESET_SHIP, INDOOR, LANDMARK_VERMILION_CITY, MUSIC_SS_ANNE, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map SSAnneCaptainsCabin, TILESET_SHIP, INDOOR, LANDMARK_VERMILION_CITY, MUSIC_SS_ANNE, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map SSAnne1FCabins, TILESET_SHIP, INDOOR, LANDMARK_VERMILION_CITY, MUSIC_SS_ANNE, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map SSAnne2FCabins, TILESET_SHIP, INDOOR, LANDMARK_VERMILION_CITY, MUSIC_SS_ANNE, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map SSAnneB1FCabins, TILESET_SHIP, INDOOR, LANDMARK_VERMILION_CITY, MUSIC_SS_ANNE, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	assert_table_length NUM_FAST_SHIP_MAPS

MapGroup_Indigo:
	table_width MAP_LENGTH, MapGroup_Indigo
	map Route23, TILESET_PLATEAU, ROUTE, LANDMARK_ROUTE_23, MUSIC_INDIGO_PLATEAU, FALSE, PALETTE_AUTO, FISHGROUP_SHORE
...
MapGroup_Fuchsia:
	...
	map FuchsiaMart, TILESET_MART, INDOOR, LANDMARK_FUCHSIA_CITY, MUSIC_CERULEAN_CITY, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	...
	map FuchsiaGym, TILESET_LAB, INDOOR, LANDMARK_FUCHSIA_CITY, MUSIC_GYM_THEME, TRUE, PALETTE_DAY, FISHGROUP_SHORE
	map BillsBrothersHouse, TILESET_HOUSE_KANTO, INDOOR, LANDMARK_FUCHSIA_CITY, MUSIC_CERULEAN_CITY, FALSE, PALETTE_DAY, FISHGROUP_SHORE
...
MapGroup_Lavender:
	...
	map MrFujisHouse, TILESET_HOUSE_KANTO, INDOOR, LANDMARK_LAVENDER_TOWN, MUSIC_LAVENDER_TOWN, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map LavenderSpeechHouse, TILESET_HOUSE_KANTO, INDOOR, LANDMARK_LAVENDER_TOWN, MUSIC_LAVENDER_TOWN, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map LavenderNameRater, TILESET_HOUSE_KANTO, INDOOR, LANDMARK_LAVENDER_TOWN, MUSIC_LAVENDER_TOWN, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	...
	map LavRadioTower1F, TILESET_RADIO_TOWER, INDOOR, LANDMARK_POKEMON_TOWER, MUSIC_LAVENDER_TOWN, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map Route8SaffronGate, TILESET_GATE_KANTO, GATE, LANDMARK_ROUTE_8, MUSIC_VIRIDIAN_CITY, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map Route8UndergroundPathEntrance, TILESET_GATE_KANTO, GATE, LANDMARK_ROUTE_6, MUSIC_ROUTE_3, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map Route12SuperRodHouse, TILESET_HOUSE_KANTO, INDOOR, LANDMARK_ROUTE_12, MUSIC_VIRIDIAN_CITY, FALSE, PALETTE_DAY, FISHGROUP_SHORE
...
MapGroup_Silver:
	...
	map Route28SteelWingHouse, TILESET_HOUSE_KANTO, INDOOR, LANDMARK_ROUTE_28, MUSIC_AZALEA_TOWN, FALSE, PALETTE_DAY, FISHGROUP_SHORE
...
MapGroup_Celadon:
	...
	map Route17, TILESET_KANTO, ROUTE, LANDMARK_ROUTE_17, MUSIC_BICYCLE, FALSE, PALETTE_AUTO, FISHGROUP_NONE
	...
	map CeladonMansionRoofHouse, TILESET_HOUSE_KANTO, INDOOR, LANDMARK_CELADON_CITY, MUSIC_CELADON_CITY, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	...
	map CeladonGym, TILESET_TRAIN_STATION, INDOOR, LANDMARK_CELADON_CITY, MUSIC_GYM_THEME, TRUE, PALETTE_DAY, FISHGROUP_SHORE
	map CeladonCafe, TILESET_GAME_CORNER, INDOOR, LANDMARK_CELADON_CITY, MUSIC_CELADON_CITY, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map Route16FuchsiaSpeechHouse, TILESET_HOUSE_KANTO, INDOOR, LANDMARK_ROUTE_16, MUSIC_CELADON_CITY, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map Route16Gate1F, TILESET_GATE_KANTO, GATE, LANDMARK_ROUTE_16, MUSIC_ROUTE_3, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map Route16Gate2F, TILESET_GATE_KANTO, GATE, LANDMARK_ROUTE_16, MUSIC_ROUTE_3, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map Route16NorthGate, TILESET_GATE_KANTO, GATE, LANDMARK_ROUTE_16, MUSIC_ROUTE_3, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map Route7SaffronGate, TILESET_GATE_KANTO, GATE, LANDMARK_ROUTE_7, MUSIC_VIRIDIAN_CITY, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map Route7UndergroundPathEntrance, TILESET_GATE_KANTO, GATE, LANDMARK_ROUTE_6, MUSIC_ROUTE_3, FALSE, PALETTE_DAY, FISHGROUP_SHORE
...
MapGroup_Viridian:
	...
	map ViridianGym, TILESET_TRAIN_STATION, INDOOR, LANDMARK_VIRIDIAN_CITY, MUSIC_GYM_THEME, TRUE, PALETTE_DAY, FISHGROUP_SHORE
	map ViridianNicknameSpeechHouse, TILESET_HOUSE_KANTO, INDOOR, LANDMARK_VIRIDIAN_CITY, MUSIC_VIRIDIAN_CITY, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	...
	map ViridianTrainerSchool, TILESET_HOUSE_KANTO, INDOOR, LANDMARK_VIRIDIAN_CITY, MUSIC_VIRIDIAN_CITY, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map Route2TradeHouse, TILESET_HOUSE_KANTO, INDOOR, LANDMARK_ROUTE_2, MUSIC_VIRIDIAN_CITY, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map Route2Gate, TILESET_GATE_KANTO, GATE, LANDMARK_ROUTE_2, MUSIC_VIRIDIAN_CITY, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map Route22Gate, TILESET_GATE_KANTO, GATE, LANDMARK_ROUTE_22, MUSIC_INDIGO_PLATEAU, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map ViridianForestSouthGate, TILESET_GATE_KANTO, GATE, LANDMARK_ROUTE_2, MUSIC_VIRIDIAN_CITY, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map ViridianForestNorthGate, TILESET_GATE_KANTO, GATE, LANDMARK_ROUTE_2, MUSIC_VIRIDIAN_CITY, FALSE, PALETTE_DAY, FISHGROUP_SHORE
...
MapGroup_Saffron:
	...
	map SaffronGym, TILESET_UNDERGROUND, INDOOR, LANDMARK_SAFFRON_CITY, MUSIC_GYM_THEME, TRUE, PALETTE_DAY, FISHGROUP_SHORE
	...
	map MrPsychicsHouse, TILESET_HOUSE_KANTO, INDOOR, LANDMARK_SAFFRON_CITY, MUSIC_VIRIDIAN_CITY, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	...
	map Route5UndergroundPathEntrance, TILESET_GATE_KANTO, GATE, LANDMARK_ROUTE_5, MUSIC_ROUTE_3, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map Route5SaffronGate, TILESET_GATE_KANTO, GATE, LANDMARK_ROUTE_5, MUSIC_VIRIDIAN_CITY, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map DayCare, TILESET_HOUSE_KANTO, INDOOR, LANDMARK_ROUTE_5, MUSIC_VIRIDIAN_CITY, FALSE, PALETTE_DAY, FISHGROUP_SHORE
