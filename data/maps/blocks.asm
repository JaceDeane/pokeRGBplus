...
SECTION "Johto Map Blocks 2a", ROMX
...
SECTION "Johto Map Blocks 2b", ROMX
...
Route6SaffronGate_Blocks:
	INCBIN "maps/NorthSouthSaffronGate.blk"

; Route???Gate_Blocks:
	; INCBIN "maps/NorthSouthGate1F.blk"
...
Route16Gate1F_Blocks:
	INCBIN "maps/EastWestGate1F.blk"
...
Route16NorthGate_Blocks:
	INCBIN "maps/Route16NorthGate.blk"
